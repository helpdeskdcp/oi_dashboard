...
def get_overview(*, memory_store=None, db_path: str = "oi_history.db") -> dict:
    ...
    return {
        "agents": orchestrator.registry_snapshot(store),
        "infrastructure": _infra_summary(db_path),
        "risk_state": {
        ...
        "security_alerts": sysadmin_store.list_reports(module="security_audit", limit=10),
        "recovery_history": sysadmin_store.list_reports(module="self_healing", limit=10),
        "recent_findings": sysadmin_store.list_reports(limit=20),
    }
